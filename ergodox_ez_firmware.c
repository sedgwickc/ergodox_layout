...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = KEYMAP(KC_EQUAL,KC_1,KC_2,KC_3,KC_4,KC_5,KC_LEFT,KC_QUOTE,KC_Q,KC_W,KC_E,KC_R,KC_T,TG(1),KC_LSPO,KC_A,KC_S,KC_D,KC_F,KC_G,KC_LCTL,CTL_T(KC_Z),KC_X,KC_C,KC_V,KC_B,ALL_T(KC_NO),LT(1,KC_GRAVE),KC_DELETE,KC_EQUAL,KC_LEFT,KC_RIGHT,ALT_T(KC_APPLICATION),KC_LGUI,KC_HOME,KC_TAB,KC_BSPACE,KC_END,KC_RIGHT,KC_6,KC_7,KC_8,KC_9,KC_0,KC_BSLASH,KC_PGUP,KC_Y,KC_U,KC_I,KC_O,KC_P,KC_MINUS,KC_H,KC_J,KC_K,KC_L,KC_SCOLON,KC_RSPC,KC_PGDOWN,KC_N,KC_M,KC_COMMA,KC_DOT,KC_SLASH,KC_RCTRL,KC_UP,KC_DOWN,KC_LBRACKET,KC_RBRACKET,MO(1),KC_LALT,LT(2,KC_ESCAPE),KC_INSERT,KC_ESCAPE,KC_ENTER,KC_SPACE),
